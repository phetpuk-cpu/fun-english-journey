...
- [ ] Phase 3 (EP depth) — กำลังทยอยทำทีละโหมด:
  ...
  - [ ] หน่วยเสริม Past Simple + Future แยกต่างหากพร้อม placement quiz — ไวยากรณ์นี้มีอยู่แล้วกระจายในหลักสูตรหลัก (ผ่าน transform ที่เพิ่งขยาย) แต่หน่วยเสริมแยกยังไม่ได้ทำ — พิจารณาว่าจำเป็นจริงไหมก่อนเริ่ม
