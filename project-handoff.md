...
- [x] Badge/certificate พิมพ์ได้ — เสร็จแล้ว 12 ก.ค. 2026 (`certificate.html`) ปลดล็อกอัตโนมัติเมื่อเรียนจบทุกบทในชั้น มีปฏิทิน พ.ศ. อัตโนมัติ พิมพ์ได้ผ่าน `window.print()` — **ยังไม่ทำ**: แบบทดสอบจำลอง Cambridge Starters/Movers/Flyers (เป็นงานแยก effort สูงกว่านี้ ยกไป Tier 2)
...
- [ ] แบบทดสอบจำลอง Cambridge Starters/Movers/Flyers (ย้ายมาจาก Tier 1 — ส่วน badge/certificate ทำเสร็จแล้ว แต่ตัวแบบทดสอบจำลองยังไม่ได้ทำ)
