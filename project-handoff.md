...
อัปเดต: 11 ก.ค. 2026 (เวอร์ชัน 6 — **เขียนเนื้อหา ป.5 ครบ 32 บทเรียนใหม่แล้ว** (🏆 Champion Academy) + ชุดสั่งงานภาพ/เสียง batch 5 เสร็จแล้ว ดู `curriculum-plan-p1-2-p5-6.md` และ `curriculum-reference-real-books.md` สำหรับที่มาของแผนหลักสูตร)
...
| เนื้อหา ป.1-2-3-4-5 ครบทุกหน่วย (160 บทเรียน รวม) | `fun-english-journey/data/{p1,p2,p3,p4,p5}u{1-8}.json` | ✅ เสร็จ — เล่นได้จริงทุกบท (ป.2-3-4 เดิมชื่อ ป.3-4-5 เปลี่ยนป้ายเลขชั้นแล้ว, ป.1 และ ป.5 เขียนใหม่ทั้งหมด 11 ก.ค.) |
| ชุดสั่งงาน AI ภาพ/เสียง (5 ชุด) | `asset-production-kit.md`, `-batch2.md`, `-batch3.md`, `-batch4.md`, `-batch5.md` | ✅ เขียนเสร็จหมด — **หมายเหตุ: ชุด 1-3 ยังอ้างชื่อไฟล์แบบเก่า (p3u/p4u/p5u) มีป้ายเตือนต่อท้ายชื่อไฟล์แล้วว่าให้แปลงเป็น p2u/p3u/p4u — ชุด 4-5 (ป.1, ป.5) ใช้ prefix ถูกต้องแล้วไม่ต้องแปลง** |
...
| แผนหลักสูตรเต็ม ป.1-6 (v3, อิงหนังสือจริง + วิจัยเพิ่ม) | `curriculum-plan-p1-2-p5-6.md` | ✅ เสร็จ — เนื้อหาจริงยังขาดแค่ ป.6 (🚀 Future & Beyond) |
| ตารางรวมหนังสือเรียนจริง ป.1-4 | `curriculum-reference-real-books.md` | ✅ เสร็จ |

**สถานะรวมตอนนี้:** ป.1-2-3-4-5 มีเนื้อหาเต็มครบ 160 บทเรียน เล่นได้จริงในแอปแล้วทั้งหมด มี 5 แท็บในหน้าแผนที่ (🌻 ป.1 / 🏙️ ป.2 / 🎪 ป.3 / 🌍 ป.4 / 🏆 ป.5) — เหลือแค่ ป.6 ที่ยังไม่มีเนื้อหา (มีแผนแล้ว รอเขียน)

**ของที่ยังไม่มี:** ภาพคำศัพท์ส่วนใหญ่ (Codex/Antigravity กำลังทยอยผลิต) และเนื้อหาบทเรียนของ ป.6 (32 บทเรียนใหม่ตามแผนใน `curriculum-plan-p1-2-p5-6.md`)
...
### 3.5 ผลิตเนื้อหาต่อ ✅ ป.1-2-3-4-5 เสร็จครบแล้ว / เหลือแค่ ป.6
...
- [x] เขียนเนื้อหา ป.5 ครบทั้ง 8 หน่วยแล้ว (32 บทใหม่ — ธีม 🏆 Champion Academy: adverbs of frequency, possessive adj vs pronouns, countable/uncountable, must/mustn't, there was/were, will future, connectors) + ชุดสั่งงานภาพ/เสียง batch5 เสร็จแล้ว
- [ ] ปรับเนื้อหาตาม feedback ลูกชายหลังทดสอบเล่น (ดูข้อ 2)
- [ ] เขียนเนื้อหา ป.6 (🚀 Future & Beyond) — มีโครงหน่วยพร้อมแล้วใน `curriculum-plan-p1-2-p5-6.md` (going-to future, modals, + 3 หน่วยเชื่อม ม.ต้น: present perfect, passive voice, first conditional) — ชั้นสุดท้ายที่เหลือ
