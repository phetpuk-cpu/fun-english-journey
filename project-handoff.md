...
- [x] Phase 4b: แดชบอร์ดผู้ปกครองขั้นสูง — เสร็จแล้ว 13 ก.ค. 2026 (`parents-dashboard.js`) เพิ่ม progress bar ต่อโปรไฟล์ ("เรียนไปแล้ว X/32 บท"), จุดที่ควรฝึกฝนเพิ่ม (บทที่ได้ 1-2 ดาว), สรุปกิจกรรม 7 วันล่าสุด (จำนวนครั้ง+คะแนนเฉลี่ยพูด+เทียบเทรนด์), ปุ่มพิมพ์สรุป (`window.print()` แทนอีเมล/LINE อัตโนมัติที่ต้องมี backend) — deploy แล้ว
