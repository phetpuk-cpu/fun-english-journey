...
อัปเดต: 10 ก.ค. 2026 (เวอร์ชัน 2 — หลังแยกโครงสร้างโปรเจกต์ + ทำ ป.3-4 ครบทุกหน่วย)
...
| ชุดสั่งงาน AI ภาพ/เสียง ชุดแรก (16 บทแรก) | `asset-production-kit.md` | ✅ เสร็จ + Codex/Antigravity ผลิตแล้วเกือบครบ |
| ชุดสั่งงาน AI ภาพ/เสียง ชุดที่ 2 (48 บทใหม่) | `asset-production-kit-batch2.md` | ✅ เขียนสคริปต์เสร็จ — รอส่งให้ Codex/Antigravity ผลิต |
...
**หมายเหตุ:** `english-learning-master-plan.md` และ `curriculum-48-units.md` ที่เคยอ้างถึงในเวอร์ชันก่อนหน้าไม่มีไฟล์จริงอยู่ในระบบ (น่าจะสร้างไว้ในแชท claude.ai ครั้งก่อนแล้วไม่ได้เซฟ) — โครงหน่วย ป.3-4 ทั้ง 8 หน่วย/ชั้นตอนนี้ถูกออกแบบใหม่และเขียนเนื้อหาเต็มแล้วโดยตรงใน data/*.json (ไม่ต้องพึ่งไฟล์แผนแม่บทเดิมอีกต่อไป)

**ของที่ยังไม่มี:** ภาพคำศัพท์ (vocab) และภาพฉากของชุดที่ 2 (48 บทใหม่) ยังไม่ได้ผลิต — งานที่เหลือหลักคือส่ง `asset-production-kit-batch2.md` ให้ Codex/Antigravity ทำต่อ
