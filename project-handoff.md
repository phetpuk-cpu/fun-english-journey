...
- [x] **โหมดอนุบาล 🐣 (Phonics/ABC/CVC) — PILOT เปิดใช้แล้ว 19 ก.ค. 2026** engine phonics 5 step type + แท็บ 🐣 + asset ครบ (เสียง 108 + ภาพ 112 + เพลง 2) ทดสอบ end-to-end ผ่าน — **เหลือ: ให้เด็กอนุบาลจริงทดสอบ 2 หน่วยนำร่อง (ku1 ตัวอักษร a-g, ku5 ตระกูล -at) แล้วค่อยเขียนเนื้อหาหน่วย 2-4, 6-8 ที่เหลือ** (ดีไซน์เดิมด้านล่างเก็บไว้อ้างอิง)
