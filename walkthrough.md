...
## 2. การสร้างไฟล์เสียงหลักสูตรทั้งหมด (อนุบาล - ป.6) ✅ 4,332 ไฟล์เสียง ครบ 100%
...
* **สรุปยอดรวมทั้งระบบ**: 4,332 ไฟล์เสียง (ป.1-ป.6 จำนวน 4,224 ไฟล์ + อนุบาล Batch 8 อีก 108 ไฟล์) ปรากฏในสารบบดิสก์เรียบร้อยแล้ว (ตรวจสอบและนับจำนวนไฟล์ผ่านเชลล์สคริปต์ได้ตรงถ้วน 100%)
...
## 8. การผลิตไฟล์เสียงอนุบาล (Batch 8: Kindergarten Phonics/ABC) ✅ เสร็จ 100% (108 ไฟล์เสียง)

เราได้ดำเนินการสร้างไฟล์เสียงประจำโหมดอนุบาล (Grade Key `k`) ครบถ้วนทั้ง 108 ไฟล์เสียง ตามสเปกใน `asset-production-kit-batch8-kindergarten-audio.md`:

* **สถานะ**: ผลิตสำเร็จครบ 108 ไฟล์ (100%) บันทึกไว้ที่ [assets/audio/](file:///Volumes/Work/work01/English_fun/assets/audio/)
* **รายละเอียดประเภทไฟล์**:
  1. `phonics-{ตัวอักษร}-name.mp3` (26 ไฟล์): ชื่อเรียกตัวอักษรภาษาอังกฤษ A-Z สำเนียงมาตรฐาน
  2. `phonics-{ตัวอักษร}-sound.mp3` (26 ไฟล์): เสียงออกพยัญชนะ/สระเดี่ยว (Phoneme Pure Sounds) สังเคราะห์ด้วยเทคโนโลยี SSML IPA (/æ/, /b/, /k/ ฯลฯ) สั้น คม ไร้เสียงเอื้อน schwa
  3. `phonics-{ตัวอักษร}-word.mp3` (26 ไฟล์): คำศัพท์ตัวอย่างประจำตัวอักษร ("apple", "ball", "cat" ฯลฯ)
  4. `phonics-cvc-{คำ}.mp3` (30 ไฟล์): คำสะกด CVC สำหรับฝึกอ่านผสมคำในหน่วยที่ 5–8 ("cat", "man", "pig", "bed" ฯลฯ)
* **คุณภาพเสียง**: ใช้เสียงผู้หญิงโมเดล `en-US-Neural2-F` ความเร็วช้าลง 15% (0.85) เหมาะสำหรับเด็กเล็ก 4–6 ขวบฟังตามและฝึกเปล่งเสียงได้อย่างเป็นธรรมชาติ
